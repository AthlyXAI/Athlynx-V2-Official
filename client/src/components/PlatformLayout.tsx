...
const APPS = [
  ...
  { id: "ai-scouting-report", label: "AI Scouting Report", icon: "/athlynx-icon.png", badge: "S39", href: "/ai-scouting-report" },
  { id: "highlight-reel-studio", label: "Reel Studio", icon: "/athlynx-icon.png", badge: "S39", href: "/highlight-reel-studio" },
  { id: "notification-center", label: "Notifications", icon: "/athlynx-icon.png", badge: "S39", href: "/notification-center" },
