...
const APPS = [
  ...
  { id: "music", label: "Music Platform", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/music" },
  { id: "reel-masters", label: "Reel Masters", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/reel-masters" },
  { id: "social-hub", label: "Social Hub", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/social-hub" },
  { id: "comms-hub", label: "Comms Hub", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/comms-hub" },
  { id: "nil-calculator", label: "NIL Calculator", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/nil-calculator" },
  { id: "nil-marketplace", label: "NIL Marketplace", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/nil-marketplace" },
  { id: "agent-finder", label: "Agent Finder", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/agent-finder" },
  { id: "signing-day", label: "Signing Day", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/signing-day" },
  { id: "court-kings", label: "Court Kings", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/court-kings" },
  { id: "pitch-pulse", label: "Pitch Pulse Soccer", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/pitch-pulse" },
  { id: "fairway-elite", label: "Fairway Elite Golf", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/fairway-elite" },
  { id: "x-factor", label: "X-Factor Feed", icon: "/xfactor-logo-dark.png", badge: "HOT", href: "/x-factor" },
  { id: "nil-jobs", label: "NIL Jobs", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/nil-jobs" },
  { id: "elite-events", label: "Elite Events", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/elite-events" },
  { id: "wellness", label: "Wellness Portal", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/wellness" },
  { id: "investor-hub", label: "Investor Hub", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/investor-hub" },
  ...
  { id: "browse-athletes", label: "Browse Athletes", icon: "/logos/athlynx-logo.png", badge: "NEW", href: "/browse-athletes" },
