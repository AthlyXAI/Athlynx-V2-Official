          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-4">
                ...
                <button className="w-full bg-red-600 hover:bg-red-500 text-white text-sm font-bold py-2 rounded-lg transition-colors">
                  Start Program
                </button>
              </div>
            ))}
          ...
          <div className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-4">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 py-3 border-b border-blue-900 last:border-0">
                <span className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-black ${i === 0 ? 'bg-red-500 text-black' : i === 1 ? 'bg-gray-400 text-black' : 'bg-red-700 text-white'}`}>{player.rank}</span>
                ...
                <div className="text-red-400 font-bold">{player.score.toLocaleString()} pts</div>
              </div>
            ))}
          </div>
        )}
        ...
        {activeTab === "analytics" && (
          <div className="space-y-4">
            <div className="bg-[#1a3a8f] border border-red-700 rounded-xl p-5">
              ...
              {!user ? (
                <div className="text-center py-4">
                  <a href="/signin" className="bg-red-600 hover:bg-red-500 text-white font-bold px-6 py-2.5 rounded-xl transition-colors">Sign In to Use AI Coach</a>
                </div>
              ) : (
                <>
                  ...
                  {aiPlan && (
                    <div className="mt-4 bg-[#0d1f3c] border border-red-700 rounded-xl p-4">
                      <div className="text-red-400 text-xs font-bold mb-2">AI PERFORMANCE COACH</div>
