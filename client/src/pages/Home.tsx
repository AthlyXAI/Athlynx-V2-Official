...
function HeroSignupForm() {
  return (
    <div className="flex flex-col gap-3">
      <a
        href="/signin"
        className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-cyan-500 hover:to-blue-600 text-white font-black text-base py-4 rounded-2xl transition-all shadow-lg hover:scale-[1.02] active:scale-[0.98]"
      >
