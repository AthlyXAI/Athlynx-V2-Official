  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-bold text-base py-3.5 rounded-2xl transition-all shadow-lg hover:scale-[1.02] active:scale-[0.98]"
      >
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 bg-black hover:bg-gray-900 text-white font-bold text-base py-3.5 rounded-2xl transition-all shadow-lg hover:scale-[1.02] active:scale-[0.98]"
      >
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-blue-600/50 text-xs">or</span>
        <div className="flex-1 h-px bg-blue-900/40" />
      </div>
      <button
        onClick={() => handleSignUp()}
        className="w-full flex items-center justify-center gap-3 bg-blue-600/20 border border-blue-500/40 hover:bg-blue-600/30 text-blue-300 font-semibold text-base py-3.5 rounded-2xl transition-all shadow-lg hover:scale-[1.02] active:scale-[0.98]"
      >
