...
export default function ScoutWizard() {
  ...
  const handleAsk = () => {
    ...
    wizardMutation.mutate({ wizardType: "scout", context: question });
  };

  const QUICK_PROMPTS = ['How do I get a coach to notice me?', 'What should be in my highlight reel?', 'How do I find the right showcases?', 'How do I build a recruiting profile?'];
        ...
        <div className="bg-gradient-to-r from-[#1a3a8f] to-[#1a2a4a] border border-blue-700 rounded-xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-300 text-sm">Get noticed by coaches and scouts</p>
            </div>
          </div>
        </div>
