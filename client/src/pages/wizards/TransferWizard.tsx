...
export default function TransferWizard() {
  ...
  const handleAsk = () => {
    ...
    wizardMutation.mutate({ wizardType: "transfer", context: question });
  };

  const QUICK_PROMPTS = ['How do I enter the transfer portal?', 'What are my eligibility options?', 'How do I contact coaches at new schools?', 'What should I look for in a new program?'];
        ...
        <div className="bg-gradient-to-r from-[#1a3a8f] to-[#1a2a4a] border border-blue-700 rounded-xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-300 text-sm">Navigate the transfer portal with AI guidance</p>
            </div>
          </div>
        </div>
