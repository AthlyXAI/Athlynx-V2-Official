...
export default function LawyerWizard() {
  ...
  const handleAsk = () => {
    ...
    wizardMutation.mutate({ wizardType: "lawyer", context: question });
  };

  const QUICK_PROMPTS = ['What should I look for in an NIL contract?', 'What are my rights as a college athlete?', 'How do agent contracts work?', 'What is an endorsement deal?'];
      ...
      <div className="max-w-2xl mx-auto space-y-5 pb-10">
        <div className="bg-gradient-to-r from-[#1a3a8f] to-[#1a2a4a] border border-blue-700 rounded-xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-white">Legal Wizard</h1>
              <p className="text-blue-300 text-sm">Understand your rights and NIL contracts</p>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-[#1a3a8f] border-blue-800">
            <CardContent className="p-5">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 rounded-full bg-blue-700 flex items-center justify-center text-lg">⚖️</div>
