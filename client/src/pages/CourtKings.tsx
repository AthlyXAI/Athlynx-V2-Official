...
export default function CourtKings() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0020]">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-[#0d0020]/95 backdrop-blur border-b border-blue-950/30">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-xs text-blue-500 font-bold tracking-widest">COURT KINGS</div>
      ...
      <section className="relative overflow-hidden py-20 px-4">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-950 via-[#0d0020] to-red-950/30 opacity-70" />
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-950/40 border border-blue-800/50 rounded-full px-4 py-1.5 mb-6">
            <span className="text-blue-500 text-xs font-bold tracking-widest">COURT KINGS</span>
          ...
          <h1 className="text-6xl md:text-7xl font-black text-white mb-4 leading-none">
            DOMINATE<br />
            <span className="text-red-400">THE COURT</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signin" className="flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-600 text-white font-bold text-lg px-8 py-4 rounded-xl transition-all hover:scale-105">
              🏆 Find Tournaments
            </Link>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {activeTab === "overview" && (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
              {features.map((f) => (
                <div key={f.title} className="bg-white/5 border border-blue-950/30 rounded-xl p-5 hover:border-blue-700/50 transition-all">
          ...
          {activeTab === "tournaments" && (
            <div className="space-y-4">
              {[
                ...
                <div key={t.name} className="bg-white/5 border border-blue-950/30 rounded-xl p-5 flex items-center justify-between hover:border-blue-700/50 transition-all">
                  <div>
                    <div className="text-white font-bold">{t.name}</div>
                    <div className="text-gray-400 text-sm">{t.date} · {t.location}</div>
                    <span className="text-xs bg-blue-950/40 text-blue-500 px-2 py-0.5 rounded-full mt-1 inline-block">{t.circuit}</span>
                  </div>
                  <div className="text-right">
                    <div className="text-red-400 font-bold">{t.teams > 0 ? `${t.teams} teams` : "Invite Only"}</div>
                    <button className="mt-2 bg-blue-700 hover:bg-blue-600 text-white text-xs font-bold px-4 py-1.5 rounded-lg transition-colors">
          ...
          {activeTab === "rankings" && (
            <div className="space-y-3">
              {[
                ...
                <div key={player.rank} className="bg-white/5 border border-blue-950/30 rounded-xl p-4 flex items-center gap-4 hover:border-red-500/30 transition-all">
                  ...
                  <div className="text-center">
                    <div className="bg-blue-950/40 text-blue-500 text-xs font-bold px-2 py-0.5 rounded">{player.pos}</div>
          ...
          {activeTab === "nil" && (
            <div className="grid md:grid-cols-2 gap-5">
              {[
                ...
                <div key={deal.brand} className="bg-white/5 border border-blue-950/30 rounded-xl p-5 hover:border-red-500/30 transition-all">
                  ...
                  <button className="w-full bg-blue-700 hover:bg-blue-600 text-white font-bold py-2 rounded-lg text-sm transition-colors">
                    Apply for Deal
                  </button>
                </div>
              ))}
      ...
      {/* CTA */}
      <section className="py-16 px-4 bg-gradient-to-r from-blue-950/40 to-red-900/20 border-t border-blue-950/30">
      ...
      <footer className="py-8 px-4 border-t border-blue-950/30 text-center">
