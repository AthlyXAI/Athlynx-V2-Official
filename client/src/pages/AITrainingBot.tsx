...
export default function AITrainingBot() {
  ...
  // Static mock — aiCredits/aiBots routers not yet implemented
  const userCredits = 50;
  const generateMutation = {
    mutateAsync: async (input: { prompt: string }) => {
      await new Promise(r => setTimeout(r, 1500));
      return { result: `**Personalized Training Plan**\n\nBased on your goals: "${input.prompt}"\n\n**Week 1-2: Foundation**\n- Monday: Strength training (45 min)\n- Tuesday: Cardio intervals (30 min)\n- Wednesday: Rest & recovery\n- Thursday: Sport-specific drills (60 min)\n- Friday: Strength training (45 min)\n- Saturday: Active recovery\n- Sunday: Rest\n\n**Nutrition Tips:**\n- Protein: 1.6g per kg bodyweight\n- Hydration: 3L water daily\n- Pre-workout: Complex carbs 2h before\n\n*Generated by ATHLYNX AI Coach*` };
    },
  };
