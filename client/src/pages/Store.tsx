...
const staticProducts = [
  ...
  { id: 206, sku: "AI-CRED-1K", name: "AI Credits Pack — 1,000 Credits", category: "software", price: 69.99, image: "https://images.unsplash.com/photo-1676277791608-ac54525aa94d?w=600&q=80", rating: 4.9, reviews: 892, description: "Includes 150 bonus credits", requiresQuote: false },
  { id: 207, sku: "AI-CRED-5K", name: "AI Credits Pack — 5,000 Credits", category: "software", price: 299.99, image: "https://images.unsplash.com/photo-1655720031554-a929595ffad7?w=600&q=80", rating: 5.0, reviews: 234, description: "Includes 1,000 bonus credits", requiresQuote: false },
  ...
  { id: 506, sku: "RD-HEXAPOD", name: "Hexapod Robot Dog", category: "fuelbots", price: 0, image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=600&q=80", rating: 5.0, reviews: 0, description: "6-legged all-terrain companion - Contact sales", requiresQuote: true },
  { id: 507, sku: "RD-HYBRID", name: "Wheel-Leg Hybrid Robot", category: "fuelbots", price: 0, image: "https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=600&q=80", rating: 5.0, reviews: 0, description: "Speed + stability hybrid - Contact sales", requiresQuote: true },
  { id: 508, sku: "RD-MEDIUM", name: "Medium Size Robot Dog", category: "fuelbots", price: 0, image: "https://images.unsplash.com/photo-1676277791608-ac54525aa94d?w=600&q=80", rating: 5.0, reviews: 0, description: "25kg payload, 4-6hr battery - Contact sales", requiresQuote: true },
