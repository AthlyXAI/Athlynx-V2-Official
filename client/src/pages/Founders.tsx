...
const TEAM = [
  {
    ...
    tags: [
      ...
      { label: "Athlete Advocate", color: "bg-blue-950 text-blue-300" },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: "VP Technology", color: "bg-blue-950 text-blue-500" },
  ...
  },
  {
    ...
    tags: [
      { label: "VP Sales", color: "bg-red-900 text-red-400" },
      { label: "Partnerships", color: "bg-red-900 text-red-300" },
      { label: "Revenue Leader", color: "bg-red-900 text-red-300" },
    ],
