...
const SPORTS = ["All", "Football", "Basketball", "Baseball", "Soccer", "Track & Field",
...
function AthleteCard({ athlete }: { athlete: any }) {
  ...
  return (
    <Link href={`/athlete/${athlete.userId}`}>
      <div className="bg-[#0d1b3e] border border-white/10 rounded-2xl overflow-hidden hover:border-[#00c2ff]/40 hover:shadow-lg hover:shadow-[#00c2ff]/10 transition-all cursor-pointer group">
        ...
        <div className="px-4 -mt-8 pb-4">
          ...
          {athlete.school && (
            <p className="text-white/30 text-xs truncate mb-3">{athlete.school}</p>
          )}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-white/40 text-sm">Discover talent across every sport and level</p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="mt-10 bg-gradient-to-r from-blue-950/60 to-[#040c1a] border border-white/10 rounded-2xl p-6 text-center">
            ...
            <p className="text-white/40 text-sm mb-4">
              ATHLYNX connects you directly with athletes across every sport and level. NIL deals, recruiting, and more.
            </p>
