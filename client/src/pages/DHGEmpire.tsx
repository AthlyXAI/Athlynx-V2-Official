      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="bg-gradient-to-br from-[#0a1628] to-[#0d1f4a] border border-red-500/20 rounded-3xl p-8 sm:p-12">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <div className="text-red-400 text-xs uppercase tracking-[0.3em] font-bold mb-3">The Origin</div>
              ...
              <div className="space-y-4 text-blue-200 text-base leading-relaxed">
                <p>The crab is not just a logo. It is the <strong className="text-red-400">Cancer</strong> — the shared diagnosis that brought Chad A. Dozier and every one of his partners together. At Hope Lodge in Houston, strangers became brothers. Survivors became builders.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <a href="mailto:cdozier14@athlynx.ai" className="flex items-center gap-2 text-blue-400 hover:text-white transition-colors"><Mail className="w-4 h-4" />cdozier14@athlynx.ai</a>
