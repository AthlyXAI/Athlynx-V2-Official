      ...
      <div className="space-y-4 pb-20 lg:pb-4">
        <div className="bg-gradient-to-r from-[#1a3a8f] to-[#1a2a4a] border border-red-600 rounded-xl p-5">
          <div className="flex items-center gap-4">
            <img src="/faith-icon.png" alt="Faith" className="w-14 h-14 rounded-2xl object-cover shadow-lg" />
            <div>
        ...
        <div className="bg-gradient-to-br from-red-900/40 to-[#1530a0] border border-red-700 rounded-xl p-5">
          <div className="text-red-400 text-xs uppercase tracking-widest mb-2">Today's Verse</div>
          <blockquote className="text-white text-lg font-semibold leading-relaxed mb-2">
            "I can do all things through Christ who strengthens me."
          </blockquote>
          <div className="text-red-400 text-sm">— Philippians 4:13</div>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="bg-[#1530a0] rounded-xl p-3 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-red-700 flex items-center justify-center text-lg shrink-0">✝️</div>
                <div className="flex-1">
                  <div className="font-semibold text-white text-sm">{dev.title}</div>
                  <div className="text-blue-400 text-xs">{dev.day} • {dev.desc}</div>
                </div>
                <button className="text-red-400 hover:text-white text-xs transition-colors">Read →</button>
              </div>
            ))}
          </div>
        </div>
        <div className="bg-[#1a3a8f] border border-blue-900 rounded-xl p-4">
          ...
          <textarea className="w-full bg-[#1a3a8f] border border-blue-800 text-white text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:border-red-500 placeholder-blue-500 h-20 resize-none" placeholder="Share a prayer request or praise report..." />
          <button className="w-full mt-2 bg-red-700 hover:bg-red-600 text-white font-bold py-2.5 rounded-xl transition-colors">Post to Prayer Wall</button>
        </div>
      </div>
    </PlatformLayout>
  );
