...
export const STRIPE_PLANS = [
  ...
  },
  {
    ...
    stripePriceIdMonthly: process.env.STRIPE_PRICE_PRO_TEAMS ?? "price_1TSnkERjBH07kRLYYlitSqLm",
    stripePriceIdYearly: process.env.STRIPE_PRICE_PRO_TEAMS_YEARLY ?? "price_1TSnkMRjBH07kRLYf8UZwzKf",
    badge: "Pro Teams",
    color: "#ef4444",
    trialDays: 30,
  }
