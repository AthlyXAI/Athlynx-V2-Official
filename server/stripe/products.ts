...
export const STRIPE_PLANS = [
  ...
  },
  {
    ...
    stripePriceIdMonthly: process.env.STRIPE_PRICE_STARTER ?? process.env.STRIPE_PRICE_STARTER_MONTHLY ?? "price_1TTsfWGvvjXZw2uELibMJ9Wb",
    stripePriceIdYearly: process.env.STRIPE_PRICE_STARTER_YEARLY ?? "price_1TTsfWGvvjXZw2uEzVAxheFn",
  ...
  },
  {
    ...
    stripePriceIdYearly: process.env.STRIPE_PRICE_CHAMPION_YEARLY ?? "price_1TTsfXGvvjXZw2uEzXkt98rb",
    badge: "Champion Tier",
    color: "#f59e0b",
    trialDays: 7,
  },
  {
    ...
    stripePriceIdYearly: process.env.STRIPE_PRICE_MVP_YEARLY ?? "price_1TTsfXGvvjXZw2uEVobXl6mO",
    badge: "MVP — Top Tier",
    color: "#ef4444",
    trialDays: 7,
  },
